...
<body>
  ...
  <script>
    const categories = [{
        ...
        name: 'Makeup',
        size: 'large',
        count: '3 subcategories · 42 products',
        subs: [{
            label: 'Face',
            product: 'Soft-Focus Blur Foundation'
          },
          {
            label: 'Eyes',
            product: 'Velvet Kohl Eyeliner'
          },
          {
            label: 'Lips',
            product: 'Glass Tint Lip Oil'
          }
        ]
      },
      {
        ...
        name: 'Skincare',
        size: '',
        count: '3 subcategories · 28 products',
        subs: [{
            label: 'Cleansers',
            product: 'Milk Cloud Cleanser'
          },
          {
            label: 'Serums',
            product: 'Peptide Glow Serum'
          },
          {
            label: 'Moisturizers',
            product: 'Barrier Butter Cream'
          }
        ]
      },
      {
        ...
        name: 'Hair care',
        size: '',
        count: '3 subcategories · 19 products',
        subs: [{
            label: 'Shampoo',
            product: 'Silk Rice Shampoo'
          },
          {
            label: 'Hair oil',
            product: 'Shine Drop Elixir'
          },
          {
            label: 'Styling',
            product: 'Curl Whip Cream'
          }
        ]
      },
      {
        ...
        name: 'Nail care',
        size: '',
        count: '3 subcategories · 15 products',
        subs: [{
            label: 'Polish',
            product: 'Jelly Coat Lacquer'
          },
          {
            label: 'Cuticle care',
            product: 'Rose Cuticle Oil'
          },
          {
            label: 'Press-ons',
            product: 'Glass Nail Set'
          }
        ]
      },
      {
        ...
        name: 'Fragrance',
        size: '',
        count: '3 subcategories · 11 products',
        subs: [{
            label: 'Eau de parfum',
            product: 'Aura Bloom EDP'
          },
          {
            label: 'Body mist',
            product: 'Sugar Halo Mist'
          },
          {
            label: 'Rollerball',
            product: 'Petal Pocket Rollerball'
          }
        ]
      },
      {
        ...
        name: 'Bath & body',
        size: '',
        count: '3 subcategories · 17 products',
        subs: [{
            label: 'Body wash',
            product: 'Whipped Cloud Wash'
          },
          {
            label: 'Body butter',
            product: 'Velvet Skin Butter'
          },
          {
            label: 'Body scrub',
            product: 'Sugar Glow Scrub'
          }
        ]
      },
      {
        ...
        subs: [{
            label: 'Brushes',
            product: 'Blur Buff Brush'
          },
          {
            label: 'Sponges',
            product: 'Cloud Bounce Sponge'
          },
          {
            label: 'Skin tools',
            product: 'Rose Quartz Sculptor'
          }
        ]
      },
      {
        ...
        subs: [{
            label: 'Gift sets',
            product: 'Glow Starter Kit'
          },
          {
            label: 'Minis',
            product: 'Best-of-Aura Minis'
          },
          {
            label: 'Limited edition',
            product: 'Solstice Glow Box'
          }
        ]
      }
    ];

        ...
        <div class="admin-panels-secondary">
          <div class="admin-panel admin-panel-orders">
            ...
            <table class="admin-table">
              ...
              <tbody>
                <tr>
                  <td>#134</td><td>Sanduni Perera</td><td>Rs 2,398.00</td>
                  <td><span class="admin-badge admin-badge-packing">Packing</span></td>
                </tr>
                <tr>
                  <td>#133</td><td>Dilki Fernando</td><td>Rs 1,197.00</td>
                  <td><span class="admin-badge admin-badge-delivered">Delivered</span></td>
                </tr>
                <tr>
                  <td>#132</td><td>Thivanka Silva</td><td>Rs 3,594.00</td>
                  <td><span class="admin-badge admin-badge-returned">Returned</span></td>
                </tr>
                <tr>
                  <td>#131</td><td>Shehani Kavindi</td><td>Rs 899.00</td>
                  <td><span class="admin-badge admin-badge-packing">Packing</span></td>
                </tr>
                <tr>
                  <td>#130</td><td>Nethmi Wickrama</td><td>Rs 1,796.00</td>
                  <td><span class="admin-badge admin-badge-delivered">Delivered</span></td>
                </tr>
              </tbody>
            </table>
            ...
            <form id="productForm" onsubmit="event.preventDefault();">
              ...
              <div class="form-row">
                <div class="form-field">
                  ...
                  <select id="pMainCategory"></select>
                </div>
                <div class="form-field">
      ...
      <section class="content-section" id="section-orders">
        ...
        <div class="admin-panel">
          <table class="admin-table">
            ...
            <tbody>
              <tr><td>#134</td><td>Sanduni Perera</td><td>Rs 2,398.00</td><td><span class="admin-badge admin-badge-packing">Packing</span></td></tr>
              <tr><td>#133</td><td>Dilki Fernando</td><td>Rs 1,197.00</td><td><span class="admin-badge admin-badge-delivered">Delivered</span></td></tr>
              <tr><td>#132</td><td>Thivanka Silva</td><td>Rs 3,594.00</td><td><span class="admin-badge admin-badge-returned">Returned</span></td></tr>
              <tr><td>#131</td><td>Shehani Kavindi</td><td>Rs 899.00</td><td><span class="admin-badge admin-badge-packing">Packing</span></td></tr>
              <tr><td>#130</td><td>Nethmi Wickrama</td><td>Rs 1,796.00</td><td><span class="admin-badge admin-badge-delivered">Delivered</span></td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section class="content-section" id="section-customers">
        ...
        <div class="admin-panel">
          <table class="admin-table">
            ...
            <tbody>
              <tr><td>Sanduni Perera</td><td>sanduni.p@email.com</td><td>4</td><td>Rs 6,120.00</td></tr>
              <tr><td>Dilki Fernando</td><td>dilki.f@email.com</td><td>2</td><td>Rs 2,494.00</td></tr>
              <tr><td>Thivanka Silva</td><td>thivanka.s@email.com</td><td>6</td><td>Rs 9,880.00</td></tr>
              <tr><td>Shehani Kavindi</td><td>shehani.k@email.com</td><td>1</td><td>Rs 899.00</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section class="content-section" id="section-admins">
        ...
        <div class="admin-panel">
          <table class="admin-table">
            ...
            <tbody>
              <tr><td>Shehani Kavindi</td><td>Super admin</td><td>Now</td></tr>
              <tr><td>Nethmi Wickrama</td><td>Admin</td><td>2 hours ago</td></tr>
            </tbody>
          </table>
        </div>
      </section>

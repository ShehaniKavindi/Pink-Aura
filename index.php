...
<body>
  ...
  <!-- BAG DRAWER (shared — copy this block onto every page that has the header bag icon) -->
  ...
  <!-- WISHLIST DRAWER (shared — copy onto every page that has the header wishlist icon) -->
